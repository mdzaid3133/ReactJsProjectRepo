  ...
  return (
    <div>
      <div className='container mx-auto px-4 mt-5'>
        <div className='p-5 rounded-lg bg-gray-100 drop-shadow-xl border-gray-200'
          style={{
        ...
        >
          ...
          <div className="flex items-center justify-between mt-4">
            <p className='fontmd'>Filter</p>
            <button
             onClick={resateFilter}
              className='px-4 py-2 bg-gray-50:hoverbg-gray-200 text-gray-800 text-sm font-medium'
              style={{ color: mode === 'dark' ? 'white' : '' }}
            >Reset Filter</button>

          </div>

          <div className='grid grid-cols-2 md:grid-cols-3 xl:gird-cols-4 gap-4 mt-4'>
            <select
            ...
            className='px-4 py-3 w-full rounded-md bg-gray-50 border-transparent outline-0 focus:border-gray-500 focus:bg-white focus:ring-0 text-sm'
              ...
              <option value="ascending">Reating-- Low to High</option>
              <option value="descending">Reating-- HIgh to Low</option>
            </select>
